...
function Payment2() {
    ...
    if ($('#dathang-form1 #name2').val() === '') {
        ...
        $("#dathang-form1 #name2").focus();
        return false;
    }
    
    if ($('#dathang-form1 #address2').val() === '') {
        BootstrapDialog.alert({
            title: 'Thông Báo',
            message: 'Xin hãy nhập địa chỉ',
            type: BootstrapDialog.TYPE_WARNING,
        ...
        $("#dathang-form1 #address2").focus();
        return false;
    }
    
    if (!isPhone('dathang-form1 #phone2')) {
        BootstrapDialog.alert({
            title: 'Thông Báo',
            message: 'Xin hãy nhập Số Điện Thoại.',
            type: BootstrapDialog.TYPE_WARNING,
