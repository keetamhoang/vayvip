...
@section('h1_seo')
    <h1 class="h1-seo">Mã giảm giá thời trang, coupon canifa, M2, H&M
    </h1>
@endsection
        ...
        <div class="widget-wrap">
            <h2 class="entry-title h1-lazada" itemprop="headline">
                @if(!empty($lazada->title))
                    {{ $lazada->title }}
                @else
                    Mã giảm giá thời trang, coupon canifa, M2, H&M trong tháng {{ \Carbon\Carbon::now()->format('m/Y') }}
                @endif
            </h2>
            ...
            <div class="entry-content lazada" itemprop="text">
                ...
                <div class="couponh2"><h2 class="h2white">MÃ GIẢM GIÁ THỜI TRANG MỚI NHẤT, TỐT NHẤT</h2></div>
                <div id="km-coupon">
