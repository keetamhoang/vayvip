...
@section('h1_seo')
    <h1 class="h1-seo">Mã giảm giá cho sản phẩm nhà cửa, đời sống
    </h1>
@endsection
        ...
        <div class="widget-wrap">
            <h2 class="entry-title h1-lazada" itemprop="headline">
                @if(!empty($lazada->title))
                    {{ $lazada->title }}
                @else
                    Mã giảm giá cho sản phẩm nhà cửa, đời sống trong tháng {{ \Carbon\Carbon::now()->format('m/Y') }}
                @endif
            </h2>
            ...
            <div class="entry-content lazada" itemprop="text">
                ...
                <div class="couponh2"><h2 class="h2white">MÃ GIẢM GIÁ SẢN PHẨM NHÀ CỬA MỚI NHẤT, TỐT NHẤT</h2></div>
                <div id="km-coupon">
