...
@section('title')
    <title>Tổng hợp Mã giảm giá tháng {{ \Carbon\Carbon::now()->format('m/Y') }} cho các sản phẩm làm đẹp</title>
@endsection

@section('meta')
    <meta property="og:url" content="http://taichinhsmart.vn/ma-giam-gia/ma-giam-gia-lam-dep">
    <meta property="og:type" content="website"/>
    <meta property="og:title"
          content="Tổng hợp Mã giảm giá tháng {{ \Carbon\Carbon::now()->format('m/Y') }} cho các sản phẩm làm đẹp"/>
    <meta property="og:description"
          content="Danh mục tổng hợp khuyến mãi, mã giảm giá đầy đủ và cập nhật hàng ngày liên tục cho các sản phẩm làm đẹp. Khuyến mãi được tổng hợp từ các trang web thương mãi điện tử lớn tại Việt Nam. Các chị, các mẹ nhớ lưu lại để săn hàng giảm giá, tiết kiệm chi phí mua sắm nhé!"/>
...
@section('h1_seo')
    <h1 class="h1-seo">Mã giảm giá làm đẹp, voucher spa, massage, xông hơi, tạo kiểu tóc...
    </h1>
@endsection
        ...
        <div class="widget-wrap">
            <h2 class="entry-title h1-lazada" itemprop="headline">
                @if(!empty($lazada->title))
                    {{ $lazada->title }}
                @else
                    Mã giảm giá làm đẹp, voucher spa, massage, xông hơi, tạo kiểu tóc... trong tháng {{ \Carbon\Carbon::now()->format('m/Y') }}
                @endif
            </h2>
            ...
            <div class="entry-content lazada" itemprop="text">
                ...
                <div class="couponh2"><h2 class="h2white">MÃ GIẢM GIÁ LÀM ĐẸP MỚI NHẤT, TỐT NHẤT</h2></div>
                <div id="km-coupon">
