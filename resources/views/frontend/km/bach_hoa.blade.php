        ...
        <div class="widget-wrap">
            <h2 class="entry-title h1-lazada" itemprop="headline">
                @if(!empty($lazada->title))
                    {{ $lazada->title }}
                @else
                    Mã giảm giá cho các sản phẩm bách hóa trong tháng {{ \Carbon\Carbon::now()->format('m/Y') }}
                @endif
            </h2>
            ...
            <div class="entry-content lazada" itemprop="text">
                ...
                <div class="couponh2"><h2 class="h2white">MÃ GIẢM GIÁ SẢN PHẨM BÁCH HÓA MỚI NHẤT, TỐT NHẤT</h2></div>
                <div id="km-coupon">
