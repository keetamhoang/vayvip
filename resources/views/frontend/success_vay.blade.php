...
@section('content')
    ...
    <div class="container success-page">
        <div class="block">
            ...
            <div class="info">
                <h3>Bạn đã đăng ký vay vốn tín dụng thành công, ngân hàng chúng tôi sẽ liên hệ với bạn sớm nhất để hoàn tất thủ tục. <a href="{{ url('/vay-von-tin-dung') }}">TaichinhSMART.vn</a> rất hân hạnh được phục vụ và chúc bạn sử dụng nguồn vốn vay tín dụng này hiệu quả nhé!</h3>
                <ul>
                    <li>
                        ...
                        <p><i class="fa fa-check-circle"></i> Số tiền cần vay: <span>{{ number_format(Request::input('money'), 0, '.', '.') }} đ</span></p>
                        ...
                        <p><i class="fa fa-check-circle"></i> Địa chỉ chi tiết: <span>{{ Request::input('address') }}</span></p>
                    </li>
                </ul>
